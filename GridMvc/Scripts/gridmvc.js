        ...
        $(this).each(function () {
            if (!$(this).data("gridmvc")) {
                var options = {
                    ...
                    selectable: $(this).attr("data-selectable") == "true",
                    multiplefilters: $(this).attr("data-multiplefilters") == "true",
                    gridname: $(this).attr("data-gridname")
                };
...
GridMvc = (function ($) {
    ...
    gridMvc.prototype.init = function () {
        //gridname
        this.gridname = this.options.gridname;
    ...
    */
    gridMvc.prototype.openFilterPopup = function (self, html) {
        //retrieve all column filter parameters from html attrs:
        ...
        //if widget already rendered - just open popup menu:
    ...
    */
    ...
    gridMvc.prototype.getFilterQueryData = function (columnName, values) {
        ...
        for (var i = 0; i < values.length; i++) {
            ...
            url += this.gridname + "-filter=" + encodeURIComponent(columnName) + "__" + values[i].filterType + "__" + encodeURIComponent(values[i].filterValue);
